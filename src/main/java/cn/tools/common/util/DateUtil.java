...
public class DateUtil {
    ...
    // ** yyyy-MM-dd HH:mm
    public static final String fm_yyyy_MM_dd_HHmm = "yyyy-MM-dd HH:mm";
    
    // ** HH:mm
    public static final String fm_HHmm = "HH:mm";
     ...
     * @return 只包含年月日的日期
     */
    public static Date removeMillisecond(Date cur) {
        if (cur == null) {
            return cur;
        }
        Calendar cal = Calendar.getInstance();
     ...
     * @return 周
     */
    public static int getYearOfWeek(Date cur) {
        Calendar c = Calendar.getInstance();
        c.setTime(cur);
     ...
     * @return 星期
     */
    public static int getWeekByDate(Date cur) {
        Calendar c = Calendar.getInstance();
        c.setTime(cur);
        int[] weeks = { 7, 1, 2, 3, 4, 5, 6 };// 分别对应是："星期日","星期一","星期二","星期三","星期四","星期五","星期六"
